...
$page_title = 'Overdued List Report By Member Staff';
$reportView = false;
$num_recs_show = 20;
...
?>
    ...
    <fieldset>
    <div class="per_title">
    	<h2><?php echo __('Overdued List By Member Only'); ?></h2>
    </div>
    <div class="infoBox">
...
<?php
  ...
  $overdue_criteria .= " and (m.member_type_id = '2' or m.member_type_id='3')";
