...
$page_title = 'Overdued List Report By Student';
$reportView = false;
$num_recs_show = 20;
...
?>
    ...
    <fieldset>
    <div class="per_title">
    	<h2><?php echo __('Overdued List By Student Only'); ?></h2>
    </div>
    <div class="infoBox">
...
<?php
  ...
  $overdue_criteria .= " and (m.member_type_id = '4' or m.member_type_id='5' or m.member_type_id='6' or m.member_type_id='7')";
